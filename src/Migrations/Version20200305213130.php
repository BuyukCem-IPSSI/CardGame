 ...
 */
final class Version20200305213130 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE card (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, user_creator_id INT NOT NULL, name VARCHAR(255) NOT NULL, attack INT NOT NULL, life_point INT NOT NULL, cost INT NOT NULL, img_file_name VARCHAR(255) NOT NULL, INDEX IDX_161498D312469DE2 (category_id), INDEX IDX_161498D3C645C84A (user_creator_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
