...
class User implements UserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Card", mappedBy="userCreator")
     */
    private $cards;
	...
	public function __construct()
    {
        ...
        $this->listCard = new ArrayCollection();
    ...
    public function removeCard(Card $card): self
    {
        if ($this->cards->contains($card)) {
            ...
            if ($card->getUserCreator() === $this) {
                $card->setUserCreator(null);
            }
        }
